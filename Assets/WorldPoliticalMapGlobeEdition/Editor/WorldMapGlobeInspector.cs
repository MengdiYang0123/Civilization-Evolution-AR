    ...
    public class WorldMapGlobeInspector : Editor {
        ...
        void OnEnable() {
            ...
            earthStyleOptions = new string[] {
                "Natural (2K, Unlit)", 
                "Natural (2K, Standard Shader)",
                "Natural (2K, Scenic)",
                "Natural (2K, Scenic + City Lights)",
                "Alternate Style 1 (2K)",
                "Alternate Style 2 (2K)",
                "Alternate Style 3 (2K)",
                "Natural (8K, Unlit)",
                "Natural (8K, Standard Shader)",
                "Natural (8K Scenic)",
                "Natural (8K Scenic + City Lights)",
                "Natural (8K Scenic Scatter)",
                "Natural (8K Scenic Scatter + City Lights)",
                "Natural (16K, Unlit)",
                "Natural (16K Scenic)",
                "Natural (16K Scenic + City Lights)",
                "Natural (16K Scenic Scatter)",
                "Natural (16K Scenic Scatter + City Lights)",
                "Solid Color",
                "Custom",
                "Scene 1801-1850",
                "Scene 1851-1900",
            ...
            earthStyleValues = new int[] {
                ...
                (int)EARTH_STYLE.StandardShader2K,
                (int)EARTH_STYLE.Scenic,
                (int)EARTH_STYLE.ScenicCityLights,
                (int)EARTH_STYLE.Alternate1,
                (int)EARTH_STYLE.Alternate2,
                (int)EARTH_STYLE.Alternate3,
                (int)EARTH_STYLE.NaturalHighRes,
                (int)EARTH_STYLE.StandardShader8K,
                (int)EARTH_STYLE.NaturalHighResScenic, 
                (int)EARTH_STYLE.NaturalHighResScenicCityLights,
                (int)EARTH_STYLE.NaturalHighResScenicScatter,
                (int)EARTH_STYLE.NaturalHighResScenicScatterCityLights,
                (int)EARTH_STYLE.NaturalHighRes16K, 
                (int)EARTH_STYLE.NaturalHighRes16KScenic, 
                (int)EARTH_STYLE.NaturalHighRes16KScenicCityLights, 
                (int)EARTH_STYLE.NaturalHighRes16KScenicScatter, 
                (int)EARTH_STYLE.NaturalHighRes16KScenicScatterCityLights,
                (int)EARTH_STYLE.SolidColor,
                (int)EARTH_STYLE.Custom,
                (int)EARTH_STYLE.Scene_1801_1850,
                (int)EARTH_STYLE.Scene_1851_1900,
                (int)EARTH_STYLE.Scene_1901_1950,
                //(int)EARTH_STYLE.Scene_1951_2000
            };
        ...
        [MenuItem("CONTEXT/WorldMapGlobe/Bake Earth Texture")] //TO FIX: BACCKUP WITH CORRECT FOLDERS 
