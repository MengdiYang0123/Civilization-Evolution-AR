...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        public List<City> cities {
            get {
                if (_cities == null)
                    ReadCitiesPackedString(SceneManager.GetActiveScene().name, _setLanguage);
                return _cities;
            }
            set {
                _cities = value;
        ...
        [SerializeField]
        bool
            _showCountryCapitals= true;
        
        public bool showCountryCapitals {
            get {
                return _showCountryCapitals;
            }
            set {
                if (_showCountryCapitals != value) {
                    _showCountryCapitals = value;
                    isDirty = true;
                    if (countryCapitals != null) {
                        countryCapitals.SetActive(_showCountryCapitals);
                    }
                }
            }
        }
        ...
        [SerializeField]
        bool
            _showRegionCapitals= true;
        
        public bool showRegionCapitals {
            get {
                return _showRegionCapitals;
            }
            set {
                if (_showRegionCapitals != value) {
                    _showRegionCapitals = value;
                    isDirty = true;
                    if (regionCapitals != null) {
                        regionCapitals.SetActive(_showRegionCapitals);
                    }
                }
            }
        }
        ...
        [SerializeField]
        bool
            _showNormalCities= true;
        
        public bool showNormalCities {
            get {
                return _showNormalCities;
            }
            set {
                if (_showNormalCities != value) {
                    _showNormalCities = value;
                    isDirty = true;
                    if (normalCities != null) {
                        normalCities.SetActive(_showNormalCities);
                    }
                }
            }
        }
