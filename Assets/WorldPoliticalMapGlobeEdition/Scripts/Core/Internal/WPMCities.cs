...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        GameObject citiesLayer, citySpot, citySpotCapitalRegion, citySpotCapitalCountry, countryCapitals, regionCapitals, normalCities;
        ...
        */
        ...
        void ReadCitiesPackedString(string periodo, LANGUAGES_OPTIONS lingua) {
            string filename = "cities" + "_" + periodo + "_" + lingua ;
            string cityCatalogFileName = _geodataResourcesPath + "/" + periodo + "/" + "Cities" + "/" + filename;
            TextAsset ta = Resources.Load<TextAsset>(cityCatalogFileName);
            if (ta != null) {
                SetCityGeoData(ta.text);
                Resources.UnloadAsset(ta);
        ...
        public string GetCityGeoDataFileName() {
            string filename = "cities" + "_" + SceneManager.GetActiveScene().name + "_" + LANGUAGES_OPTIONS.ENGLISH + ".txt";
            return filename;
        }
        ...
        public virtual void DrawCities() {
            ...
            countryCapitals = new GameObject("Country Capitals");
            ...
            normalCities = new GameObject("Normal Cities");
        ...
        void CombineMeshes(GameObject obj, Material mat) {
            ...
            mf.mesh = new Mesh{indexFormat = IndexFormat.UInt32};
        ...
        bool GetCityUnderMouse(int countryIndex, Vector3 localPoint, out int cityIndex) {
            ...
            if (visibleCities == null)
                return false;
            float hitPrecision = CITY_HIT_PRECISION * _cityIconSize * 45.0f;
            float hitPrecisionSqr = hitPrecision * hitPrecision;
            int cityCount = visibleCities.Length;
        ...
        public int GetCityNearPoint(Vector3 localPoint, int countryIndex = -1) {
            //Debug.Log("Dentro GetCityNearPoint");
            if (visibleCities == null)
                return -1;
