...
namespace WPM {
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        void RestyleEarth() {
            ...
            {
                case "1801-1850":
                    _earthStyle = EARTH_STYLE.Scene_1801_1850;
                    break;
                case "1851-1900":
                    _earthStyle = EARTH_STYLE.Scene_1851_1900;
                    break;
                case "1901-1950":
                    _earthStyle = EARTH_STYLE.Scene_1901_1950;
                    break;
                default:
                    break;
            }
            switch (_earthStyle) {
                ...
                case EARTH_STYLE.StandardShader8K:
                    ...
                    break;
                case EARTH_STYLE.Scene_1801_1850:
                    materialName = "EarthHighRes16K";
                    break;
                case EARTH_STYLE.Scene_1851_1900:
                    materialName = "EarthHighRes16K";
                    break;
                case EARTH_STYLE.Scene_1901_1950:
                    materialName = "EarthHighRes16K";
                    break;
                default:
                    materialName = "Earth";
        ...
        void UpdateMaterialsZWrite() {
           ...
           if (categoriesBattleMat != null) {
                categoriesBattleMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
            }
           //Art
           if (categoriesArtMat != null) {
               categoriesArtMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Science
           if (categoriesScienceMat != null) {
               categoriesScienceMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Discovery
           if (categoriesDiscoveryMat != null) {
               categoriesDiscoveryMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Treaty
           if (categoriesTreatyMat != null) {
               categoriesTreatyMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Tragedy
           if (categoriesTragedyMat != null) {
               categoriesTragedyMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Fun Fact
           if (categoriesFunFactMat != null) {
               categoriesFunFactMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Human Rights
           if (categoriesHumanRightsMat != null) {
               categoriesHumanRightsMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
           //Event
           if (categoriesEventMat != null) {
               categoriesEventMat.renderQueue = zwriteValue == 1 ? RENDER_QUEUE_TRANSPARENT - 4 : RENDER_QUEUE_OPAQUE - 4;
           }
