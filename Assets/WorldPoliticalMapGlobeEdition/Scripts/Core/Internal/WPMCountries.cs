...
namespace WPM {
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        {
            string frontier =  (_frontiersDetail == FRONTIERS_DETAIL.Low ? "/countries110" : "/countries10");
            string filename = "/" + SceneManager.GetActiveScene().name + "/Countries" + frontier + "_" + SceneManager.GetActiveScene().name + "_" + _setLanguage ;
            //string filename2 = "/" + SceneManager.GetActiveScene().name + "/Countries" + "/countries10" + "_" + SceneManager.GetActiveScene().name + "_" + _setLanguage ;
            
            //string frontiersFileName = _geodataResourcesPath + (_frontiersDetail == FRONTIERS_DETAIL.Low ? "/countries110" : "/countries10");
            
            string frontiersFileName1 = _geodataResourcesPath + filename;
            //string frontiersFileName = _geodataResourcesPath + (_frontiersDetail == FRONTIERS_DETAIL.Low ? "/countries110" : "/countries10");
// SceneManager.GetActiveScene().name + "Countries" + "/" +
//GEODATA/COYNTRIES110
            //string frontiersFileName = _geodataResourcesPath + (_frontiersDetail == FRONTIERS_DETAIL.Low ? filename2 : filename1);
            //string path = _geodataResourcesPath + "/" + SceneManager.GetActiveScene().name + "/Countries" + frontiersFileName;
            TextAsset ta = Resources.Load<TextAsset>(frontiersFileName1);
            if (ta != null) {
        ...
        public void SetCountriesGeoData(string s) {
            ...
            for (int k = 0; k < countryCount; k++)
            {
                ...
                string domain = countryInfo[3];
                
                Country country = new Country(name, continent, domain);
                ...
                if (countryInfoLength >= 4) {
                    country.hidden = "1".Equals(countryInfo[5]);
                }
                // fip 10 4
                ...
                if (countryInfoLength >= 9) {
                    country.labelVisible = "1".Equals(countryInfo[9]);
                }
        ...
        public string GetCountriesGeoDataFileName() {
            ...
            string filename1 = "countries110" + "_" + SceneManager.GetActiveScene().name + "_" + LANGUAGES_OPTIONS.ENGLISH + ".txt" ;
            string filename2 = "countries10" + "-" + SceneManager.GetActiveScene().name + "_" + LANGUAGES_OPTIONS.ENGLISH + ".txt" ;

            return frontiersDetail == FRONTIERS_DETAIL.Low ? filename1 : filename2;
        }
