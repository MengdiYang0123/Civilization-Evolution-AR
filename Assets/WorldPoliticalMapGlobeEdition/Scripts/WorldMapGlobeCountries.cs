...
namespace WPM {
    ...
    public partial class WorldMapGlobe : MonoBehaviour {
        ...
        public int CountryCreate(string name, string continent , string domain) {
        ...
        public bool CountryRename(string oldName, string newName) {
            ...
            if (_cities == null) ReadCitiesPackedString(SceneManager.GetActiveScene().name, _setLanguage);
        ...
        /// <summary>
        /// Renames the Domain's country. Name must be unique, different from current and one letter minimum.
        /// </summary>
        ///Maybe deve restituire false???
        
        public bool CountryNewDomain(string countryName, string oldDomain, string newDomain) {
            ...
            countries[countryIndex].domain = newDomain;
            lastCountryLookupCount = -1;
            return true;
